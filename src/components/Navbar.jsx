        ...
        <nav className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white shadow-sm dark:border-emerald-950 dark:bg-[#022c22] transition-colors duration-300">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-6 h-16">
                        ...
                        <CustomNavLink to="/add-tutor">Add Tutors</CustomNavLink>
                                ...
                                >
                                    ...
                                    {hasValidImage ? (
                                        <img 
                                            ...
                                            onError={(e) => {
                                                // কোনো কারণে ডাটাবেজের ইমেজ লিংক কাজ না করলে টেক্সট অবতার লোড হবে
                                                e.target.style.display = 'none';
                                                e.target.parentElement.innerText = getInitials(user?.name);
                                            }}
                                        />
                                    ) : (
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden border-t border-slate-200 bg-white px-4 py-4 space-y-2 dark:border-emerald-900 dark:bg-[#022c22] flex flex-col items-stretch">
                    ...
                    <CustomNavLink to="/add-tutor" onClick={() => setIsMobileMenuOpen(false)}>➕ Add Tutors</CustomNavLink>
                    ...
                    {user ? (
                        ...
                        <div className="flex flex-col gap-2 pt-2 border-t border-slate-100 dark:border-emerald-900">
